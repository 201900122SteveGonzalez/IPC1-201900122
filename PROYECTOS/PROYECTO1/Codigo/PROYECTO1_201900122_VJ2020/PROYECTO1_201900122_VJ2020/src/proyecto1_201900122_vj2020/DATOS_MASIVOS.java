...
//----------------------------------------------
    ...
    private static String Mecanica_precio[];
//----------------------------------------------
    private static int posicion_repuesto;
    private static String Repuesto_nombre[];
    private static String Repuesto_precio[];
    ...
    public DATOS_MASIVOS() {
        ...
        DATOS_MASIVOS.Mecanica_precio = new String[100];
        DATOS_MASIVOS.Repuesto_nombre = new String[100];
        DATOS_MASIVOS.Repuesto_precio = new String[100];
    }

    public static void limpiar_datos_masivos() {
        DATOS_MASIVOS.posicion_linea = 0;
        DATOS_MASIVOS.posicion_marca = 0;
        DATOS_MASIVOS.posicion_mecanica = 0;
        DATOS_MASIVOS.posicion_modelo = 0;
        DATOS_MASIVOS.posicion_repuesto = 0;
        DATOS_MASIVOS.posicion_tipo = 0;
        DATOS_MASIVOS.posicion_uso = 0;
        for (int i = 0; i < 100; i++) {
            DATOS_MASIVOS.Tipo_nombre[i] = null;
            DATOS_MASIVOS.Tipo_valorMaximo[i] = null;
            DATOS_MASIVOS.Modelo_año[i] = null;
            DATOS_MASIVOS.Modelo_porentaje_depreciacion[i] = null;
            DATOS_MASIVOS.Marca_nombre[i] = null;
            DATOS_MASIVOS.Marca_porcentaje_aumento_de_poliza[i] = null;
            DATOS_MASIVOS.Linea_nombre[i] = null;
            DATOS_MASIVOS.Linea_porcentaje_aumento_de_poliza[i] = null;
            DATOS_MASIVOS.Uso_nombre[i] = null;
            DATOS_MASIVOS.Uso_porcentaje_aumento_de_poliza[i] = null;
            DATOS_MASIVOS.Mecanica_nombre_actividad[i] = null;
            DATOS_MASIVOS.Mecanica_precio[i] = null;
            DATOS_MASIVOS.Repuesto_nombre[i] = null;
            DATOS_MASIVOS.Repuesto_precio[i] = null;
        }
    }
    ...
    public static void guardar_mecanica(String Mecanica_nombre_actividad, String Mecanica_precio) {
        if (DATOS_MASIVOS.getTipo_nombre()[DATOS_MASIVOS.getPosicion_mecanica()] == null) {
            ...
            DATOS_MASIVOS.getMecanica_precio()[DATOS_MASIVOS.getPosicion_mecanica()] = Mecanica_precio;
    ...
    public static void guardar_repuesto(String Repuesto_nombre, String Repuesto_precio) {
        if (DATOS_MASIVOS.getRepuesto_nombre()[DATOS_MASIVOS.getPosicion_repuesto()] == null) {
            ...
            DATOS_MASIVOS.getRepuesto_precio()[DATOS_MASIVOS.getPosicion_repuesto()] = Repuesto_precio;
    ...
    /**
     * @param aModelo_porentaje_depreciacion the Modelo_porentaje_depreciacion
     * to set
     */
    ...
    /**
     * @param aMarca_porcentaje_aumento_de_poliza the
     * Marca_porcentaje_aumento_de_poliza to set
     */
    ...
    /**
     * @param aLinea_porcentaje_aumento_de_poliza the
     * Linea_porcentaje_aumento_de_poliza to set
     */
    ...
    /**
     * @param aUso_porcentaje_aumento_de_poliza the
     * Uso_porcentaje_aumento_de_poliza to set
     */
     ...
     */
    public static String[] getMecanica_precio() {
     ...
     */
    public static void setMecanica_precio(String[] aMecanica_precio) {
     ...
     */
    public static String[] getRepuesto_precio() {
     ...
     */
    public static void setRepuesto_precio(String[] aRepuesto_precio) {
