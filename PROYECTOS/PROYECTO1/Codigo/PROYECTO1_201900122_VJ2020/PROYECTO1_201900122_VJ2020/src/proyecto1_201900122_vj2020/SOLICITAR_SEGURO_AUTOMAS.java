...
//        this.cd = 0.07*this.valor_establecido;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DecimalFormat aproximar = new DecimalFormat("#.00");
        this.PTR = this.porcentaje_marca + this.porcentaje_linea + this.porcentaje_uso;
        this.PT = this.valor_establecido * (0.1 + this.PTR);
        this.Cp = this.PT / 12;
        this.cd = 0.07 * this.valor_establecido;
        this.costo_prima.setText(String.valueOf(aproximar.format(this.Cp)));
        this.costo_deducible.setText(String.valueOf(aproximar.format(this.cd)));
        this.posible_costo_prima.setText(String.valueOf(aproximar.format(this.Cp)));
        this.posible_deducible.setText(String.valueOf(aproximar.format(this.cd)));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        this.posible_deducible.setText(String.valueOf(aproximar.format(valor_final_deducible)));
        ...
        this.posible_costo_prima.setText(String.valueOf(aproximar.format(valor_final_cp)));
        // TODO add your handling code here:
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        this.valor_de_vehiculo.setText("");
        //limpiar arreglos de datos masivos
        DATOS_MASIVOS.limpiar_datos_masivos();
        ...
        this.dispose();
        System.out.println("almacenado DPI:" + datos_solicitud_seguro.getA()[0]);
        //remover todo lo de esta ventana, para evitar problemas al volver a cargar datos.
        // TODO add your handling code here:
...
//  this.textField9.setText(DATOS_MASIVOS.getTipo_valorMaximo()[i]);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String A = this.textField3.getText();//DPI
        String B = this.textField1.getText() + " " + this.textField2.getText();//NOMBRE
        String C = this.textField4.getText();//telefono
        String D = (String) this.tipo_vehiculo.getSelectedItem();//TIPO
        String USO = (String) this.uso_vehiculo.getSelectedItem();
        String MARCA = (String) this.marca.getSelectedItem();
        String LINEA = (String) this.linea.getSelectedItem();
        String MODELO = (String) this.modelo.getSelectedItem();
        String E = D + "," + USO + "," + MARCA + "," + LINEA + "," + MODELO;//DESCRIPCION
        String F = String.valueOf(this.valor_establecido);//MONTO
        String G = this.posible_costo_prima.getText();//POLIZA
        String H = this.posible_deducible.getText();//DEDUCIBLE
        datos_solicitud_seguro.almacenar_info_solicitud(A, B, C, D, E, F, G, H);
//AÑADIR INFORMACION CARGADA A TABLA DE VENTANA DE SOLICITUDES DE SEGURO, 
        datos_solicitud_seguro.setNoSolicitud(datos_solicitud_seguro.getNoSolicitud() + 1);
        JOptionPane.showMessageDialog(null, "se ha guardado la informacion de la solicitud");
